define(['./module'],function(controllers){
    'use strict';
    controllers.controller('resetPasswordCtrl', ['$scope','$rootScope','$modal', '$log','$http','$modalInstance', 'UserService','ipCookie' ,function ($scope,$rootScope,  $modal, $log,$http,$modalInstance, UserService, ipCookie){
        ...
        $scope.submitForm = function(isValid) {
            ...
            if (isValid) {
                ...
                $http.post('api/resetPassword', data).success(function(data, status, headers, config) {
