define(['./module'],function(directives){
    directives.directive('editproblemproposal',function(){
        return {
            restrict: 'AE',
            scope: {
               value: '='
            },
            template: '<pre ng-click="edit()" ng-bind-html = "tempValue"></pre><textarea  ng-model="tempValue" wrap="hard" rows="25"></textarea>',
